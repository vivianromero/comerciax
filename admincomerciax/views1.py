...
def get_producto_list(request):
    ...
    #columnIndexNameMap is required for correct sorting behavior
    columnIndexNameMap = { 0:'id', 1:'descripcion', 2:'codigo',3:'admincomerciax_umedida.descripcion', 4:'precio_mn', 5:'precio_cuc', 6:'precio_costo_mn', 7:'precio_costo_cuc',9:'precio_externo_cup',10:'precio_particular',11:'precio_casco',12:'precio_vulca'}
    #model fields listed in searchableColumns will be used for filtering (Search)
