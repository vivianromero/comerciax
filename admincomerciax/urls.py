...
urlpatterns = patterns('comerciax.admincomerciax.views',
    ...
    url(r'^servicio/index', 'servicio', name='servicio'),
    url(r'^servicio/add', 'addservicio', name='addservicio'),
    url(r'^servicio/view/(?P<idservicio>[a-zA-Z0-9-]{0,40})/', 'viewservicio', name='viewservicio'),
    url(r'^servicio/view/$', 'viewservicio', name='viewservicio2'),

    url(r'^producciones/index', 'producciones', name='producciones'),
    url(r'^producciones/add', 'addproducciones', name='addproducciones'),
    url(r'^producciones/view/(?P<idproducciones>[a-zA-Z0-9-]{0,40})/', 'viewproducciones', name='viewproducciones'),
    url(r'^producciones/view/$', 'viewproducciones', name='viewproducciones2'),
    ...
    url(r'^servicio/edit/(?P<idservicio>[a-zA-Z0-9-]{0,40})/$', 'editservicio', name='editservicio'),
    url(r'^producciones/edit/(?P<idproducciones>[a-zA-Z0-9-]{0,40})/$', 'editproducciones', name='editproducciones'),
...
#    url(r'^cliente/contratoedit/$', 'contratoedit', name='contratoedit2'),
    ...
    url(r'^ajax/delservicio/(?P<idservicio>[a-zA-Z0-9-]{0,40})/$', 'delservicio', name='delservicio'),
    url(r'^ajax/get-servicio-list/$', 'get_servicio_list', name='get_servicio_list'),
    url(r'^ajax/delproducciones/(?P<idproducciones>[a-zA-Z0-9-]{0,40})/$', 'delproducciones', name='delproducciones'),
    url(r'^ajax/get-producciones-list/$', 'get_producciones_list', name='get_producciones_list'),
