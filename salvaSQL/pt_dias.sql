         SELECT admincomerciax_producto.descripcion, admincomerciax_producto.id, casco_doc.fecha_doc, casco_casco.casco_nro, casco_casco.id_casco, date_part('day'::text, now() - casco_doc.fecha_doc::timestamp with time zone)::integer AS dias, admincomerciax_cliente.nombre
           FROM casco_casco
